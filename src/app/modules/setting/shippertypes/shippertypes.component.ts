...
@Component({
  selector: 'app-shippertypes',
  templateUrl: './shippertypes.component.html',
  styleUrls: ['./shippertypes.component.scss']
})
export class ShippertypesComponent implements OnInit {

  modeltype:string = 'shipper_type';
  loaded = false;
  datasupscriber:any;
  ...
  loadData(){
    ...
    this.datasupscriber = this._manager.getShipperTypes().subscribe(data => {
      if(data.data){
