...
@Component({
  selector: 'app-invoicetypes',
  templateUrl: './invoicetypes.component.html',
  styleUrls: ['./invoicetypes.component.scss']
})
export class InvoicetypesComponent implements OnInit {

  modeltype:string = 'invoice_type';
  loaded = false;
  datasupscriber:any;
  ...
  loadData(){
    ...
    this.datasupscriber = this._manager.getInvoiceTypes().subscribe(data => {
      if(data.data){
