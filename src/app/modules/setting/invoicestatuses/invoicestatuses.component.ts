...
@Component({
  selector: 'app-invoicestatuses',
  templateUrl: './invoicestatuses.component.html',
  styleUrls: ['./invoicestatuses.component.scss']
})
export class InvoicestatusesComponent implements OnInit {

  modeltype:string = 'invoice_status';
  loaded = false;
  datasupscriber:any;
  ...
  loadData(){
    ...
    this.datasupscriber = this._manager.getInvoiceStatuses().subscribe(data => {
      if(data.data){
